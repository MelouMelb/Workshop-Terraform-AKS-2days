...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-mbn1101"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "terraformmbn1101"      # mettre le nom du compte de stockage créer dans le lab 1
